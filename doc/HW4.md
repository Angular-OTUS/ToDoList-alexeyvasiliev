...
* добавьте код в компонент списка который по клику на элемент списка присвоит id элемента по которому кликнули в
  selectedItemId
...
* создайте директиву в shared модуле, которая будет выводить текст подсказку при наведении на элемент к которому
  применили директиву
* примените директиву ко всем элементам в проекте у которых есть подписка на собитие click
